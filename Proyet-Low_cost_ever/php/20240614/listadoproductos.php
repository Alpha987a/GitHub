...
//Select de las imagenes por id
$sql= "SELECT ruta, alt FROM imagenes WHERE productos_id = 40";
            ...
            <div class="modal-content">
                <form action="modificarproducto.php" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div id="img-container" class="container d-flex justify-content-between">
...
<script>
    ...
    function editProducto(id, producto, descripcion, precio, unidades){
        ...
        //Recoger del json los datos de las imagenes
        img_container.textContent=""
        fetch('obtener_img.php')
        .then(response=>response.json())
        .then(data=>{
            data.forEach(img=>{
                if(img.productos_id==id){

                    const container = document.createElement('div');
                    const img_tag = document.createElement('img');
                    img_tag.src= img.ruta;
                    img_tag.alt = img.alt;
                    img_tag.width = 100;

                    container.appendChild(img_tag);
                    img_container.appendChild(container);
                }
            });
        });
